var funnel = params.funnel || [
    ...
    { event: "Screen View", screen: "Dashboard" },
    { event: "Screen View", screen: "Create Reel" },
    { event: "Screen View", screen: "Export Controller" }
  ];
    ...
    .groupByUser(function(steps_completed, events) {
      ...
      _.each(events, function(e) {
        ...
        if (steps_completed < funnel.length) {
          ...
          if (e.name === currentStep.event && (e.properties["Screen Name"] === currentStep.screen || e.properties["screen info"] === currentStep.screen)) {
            steps_completed++;
          }
        }
      });
